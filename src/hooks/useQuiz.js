...
function reducer(state, action) {
  ...
  switch (action.type) {
    ...
    case 'START_LOADING':
      ...
      return { ...initialState, screen: 'loading', genre: action.genre, pseudo: action.pseudo }
...
export function useQuiz() {
  ...
  const startGame = useCallback(async (genre, pseudo) => {

    dispatch({ type: 'START_LOADING', genre, pseudo })
